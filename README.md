...
* `UserBan` - Бан или временная блокировка пользователя.
...
#### **Запрос на бан или временную блокировку пользователя (UserBan):**
...
```
{
  ...
  "Data": {
    "Service": "Service",
    "UserID": "00000000",
    "Duration": 10 // Больше 0, чтобы поместить пользователя в тайм-аут, иначе перманентная блокировка.
  }
}
```
